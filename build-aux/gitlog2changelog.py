...
# This file is distributed under the terms of the GNU General Public License v2 or later

# Modified 2011 for use with the Microgrid project <microgrids@svp-home.org>
...
fout = sys.stdout # open('ChangeLog', 'w')
